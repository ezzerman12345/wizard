...
BUILDFILE      = 'http://www.ezzer-mac.com/ez/autobuilds.txt'
UPDATECHECK    = 0
APKFILE        = 'http://www.ezzer-mac.com/text/apk.txt'
YOUTUBETITLE   = 'http://'
YOUTUBEFILE    = 'http://'
ADDONFILE      = 'http://www.ezzer-mac.com/ez/wizard.txt'
ADVANCEDFILE   = 'http://'
ROMPACK        = 'http://'
EMUAPKS        = 'http://'
ADDONPACK      = 'http://'
...
NOTIFICATION   = 'http://www.ezzer-mac.com/ez/notify.txt'
