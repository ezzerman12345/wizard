...
def firstRun():
    class MyWindow(xbmcgui.WindowXMLDialog):
        def __init__(self, *args, **kwargs):
            ...
            self.msg   = "[COLOR black]Currently no build installed from[/COLOR] %s.\n\n[COLOR black]Select[/COLOR] [B][COLOR red]'EzZeRmAnS BUILDS'[/COLOR][/B] [COLOR black]to install a Community Build from us or[/COLOR] [B][COLOR red]'Dismiss'[/COLOR][/B] [COLOR black]to never see this message again.\n\nThank you for choosing[/COLOR] %s." % (ADDONTITLE, ADDONTITLE)
